...
train_batch_sampler = BalancedBatchSampler(train_dataset, n_classes=10, n_samples=20)
test_batch_sampler = BalancedBatchSampler(test_dataset, n_classes=10, n_samples=20)
